...
<html>
  <head>
    <title>Old Factory Cafe Admin</title>
    <meta charset="UTF-8">
  ...
  <div class="w3-container w3-yellow" id="items">
    <div class="w3-content" style="max-width:1000px">
      <h5 class="w3-center w3-padding-64">
        <span class="w3-tag w3-wide">MANAGE MENU ITEMS</span>
      </h5>

<?php
include "dbconnect.php";
//prepare a database query to read all the menu items 
...
if ($rowcount > 0)
  ...
  {
    echo '<p>No items found!</p>'; //suitable feedback
  }
