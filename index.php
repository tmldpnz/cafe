...
<div class="w3-container" id="about">
  <div class="w3-content" style="max-width:700px">
    ...
    <p><b>Haere Mai!</b></p>
      <p>The Old Factory Cafe was founded in 2014 by Tex Fewcher in an old soap factory with a view across the park. Since then the cafe has become a byword for quality food and drink and a warm welcome from the staff</p>
    <p>In addition to our full espresso and brew bar menu, we serve fresh made-to-order breakfast and lunch sandwiches, as well as a selection of sides and salads and other good stuff.</p>
    <p>Come and grab some kai!</p>
    <div class="w3-panel w3-leftbar w3-light-grey">
      <p><i>"Use products from nature for what it's worth - but never too early, nor too late." Fresh is the new sweet.</i></p>
      <p>Chef, Coffeeist and Owner: Tex Fewcher</p>
    </div>
    <img src="https://www.w3schools.com/w3images/coffeeshop.jpg" style="width:100%;max-width:1000px" class="w3-margin-top">
    <p><strong>Opening hours:</strong> everyday from 6am to 5pm.</p>
    <p><strong>Address:</strong> 15 Cafe Street, Auckland</p>
  </div>
</div>
...
<div class="w3-container" id="menu">
  <div class="w3-content" style="max-width:700px">
	...
	<?php mysqli_free_result($result); //free any memory used by the query
	//prepare a query and send it to the server
$query = 'SELECT menuid,category,name,description, price FROM menu WHERE category="drink"';
$result = mysqli_query($db_connection, $query);
$rowcount = mysqli_num_rows($result); 
?>
...
<div class="w3-container" id="where" style="padding-bottom:32px;">
  <div class="w3-content" style="max-width:700px">
    ...
    <p>Find us at the end of Cafe Street, by the park.</p>
    <img src="https://www.w3schools.com/w3images/map.jpg" class="w3-image" style="width:100%">
    <p><span class="w3-tag">FYI!</span> We offer full-service catering for any event, large or small. We understand your needs and we will cater the food to satisfy the most stringent criteria, both look and taste.</p>
